...
const ContactHeader = () => {
    return (
        <>
            <Head>
                <link key="link-stylesheet-material-icons" href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
            </Head>
                
            <div className="block-contact-header">
                <a className="contact-header__contact-point"
                    href="tel:+65 1234 5678">
                        <span className="material-icons">phone</span>
                        Phone
                </a>
                <a className="contact-header__contact-point"
                    href="mailto:admin@lhtc.sg">
        ...
        <>
            ...
            <amp-consent layout="nodisplay" id="consent-element">
                ...
                <div id="block-consent-ui">
                    <p>By clicking "continue", you consent to our <a href="/policies/privacy">privacy policy</a>.</p>
                    <button on="tap:consent-element.accept">Continue</button>
                </div>
            </amp-consent>
...
const NavigationHeader = () => {
    return (
        <>
            ...
            <amp-sidebar id="site-navigation-sidebar"
                layout="nodisplay">
            ...
            <div className="block-navigation-header">
                <div className="short-logo__wrapper">
                    <amp-img className="navigation-header__short-logo"
...
const SEOHeader = () => {
    return (
        <Head>
            ...
            <meta name="description" content="Quality tuition backed by a pool of competent tutors with years of experience. Learning Habitat is a professional Primary and Secondary tuition centre in Singapore, registered with the Ministry of Education since 2006." />
